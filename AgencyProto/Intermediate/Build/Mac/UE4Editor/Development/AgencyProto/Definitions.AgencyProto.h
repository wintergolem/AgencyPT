#undef AGENCYPROTO_API
#undef AGENCYPROTO_VTABLE
...
#define UE_PROJECT_NAME AgencyProto
...
#define AGENCYPROTO_VTABLE DLLEXPORT_VTABLE
#define AGENCYPROTO_API DLLEXPORT
